...
ALTER TABLE RestaurantInfo
	DROP CONSTRAINT  fk_RestaurantInfo_locationId;
ALTER TABLE Location
	DROP CONSTRAINT  fk_Location_restaurantId;

/*Dropping the tables*/
DROP TABLE IF EXISTS SocialMediaPopularity;
...
popularTime TIME, 
uberEatsRating DECIMAL(1), 
googleRating DECIMAL(1), 
tripadvisorRating DECIMAL(1), 
yelpRating DECIMAL(1), 
AvgRating DECIMAL(1), 
locationId CHAR(2),
CONSTRAINT pk_RestaurantInfo_restaurantId PRIMARY KEY (restaurantId));

INSERT INTO RestaurantInfo VALUES
...
('8','Looneys','$$','Friday','11:00 PM',NULL,4.2,4,3.5,4.06,'8'),
('9','Dennys','$','Saturday','10:00 AM',4.5,4.0,4.0,2.5,4.02,'9'),
('10','Papa Johns','$','Thursday','9:00 PM',4.4,3.2,3.5,1.5,3.51,'10'),
('11','McDonalds','$','Wednesday','1:00 PM',4.3,3.4,NULL,1.5,3.55,'11'),
('12','Potbellys','$','Thursday','12:00 PM',4.8,4.1,4.0,3.5,4.13,'12'),
...
restaurantArea VARCHAR(20), 
distanceFromVMH DECIMAL(2), 
northOrSouthCampus VARCHAR(20), 
longitute DECIMAL(10),
latitude DECIMAL(10),
restaurantId CHAR(2),
CONSTRAINT pk_Location_locationId PRIMARY KEY (locationId),
CONSTRAINT fk_Location_restaurantId FOREIGN KEY (restaurantId) 
	REFERENCES RestaurantInfo (restaurantId) 
...
CREATE TABLE SocialMediaPopularity( 
...
CONSTRAINT fk_SocialMediaPopularity_restaurantId FOREIGN KEY (restaurantId) 
   ...
   INSERT INTO SocialMediaPopularity VALUES
